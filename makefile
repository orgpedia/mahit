...
import/websites/gr.maharashtra.gov.in/IT:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/IT .
...
import: check_env import/websites/gr.maharashtra.gov.in/IT .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/IT import/documents
